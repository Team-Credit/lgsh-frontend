      ...
      <Header className="main-header">
        ...
        <div className="header-right">
          ...
          <Dropdown
            menu={{
              items: alerts.length > 0
                ? [
                      ...
                      label: (
                        <div
                          style={{
                            maxWidth: 300,
                            padding: '4px 0',
                            opacity: alert.readYn === 'Y' ? 0.6 : 1,
                          }}
                          onClick={() => handleReadAlert(alert.alertId, alert.linkUrl)}
                        >
                          <div style={{ fontWeight: alert.readYn === 'N' ? 600 : 400 }}>
                            {alert.alertTitle}
                          </div>
                    ...
                    {
                      key: 'toggle-hide-read',
                      label: hideReadAlerts ? '읽은 알림 보이기' : '읽은 알림 숨기기',
                ...
                : [
                    {
                      key: 'empty',
                      label: <div style={{ color: '#999', textAlign: 'center' }}>알림이 없습니다</div>,
                      disabled: true,
                    },
                  ],
            }}
            placement="bottomRight"
            trigger={['click']}
            onOpenChange={(open) => open && fetchAlerts()}
          >
            <Tooltip title="알림">
